...
namespace UicBundle\Controller\Departament;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use UicBundle\Entity\Departament\Departament;
use UicBundle\Form\Departament\DepartamentType;
use UicBundle\Factory\DepartamentFactoryInf;
use UicBundle\Application\UseCase\Departament\FindAllDepartamentUseCase;
use UicBundle\Application\UseCase\Departament\CreateDepartamentUseCase;
use UicBundle\Application\UseCase\Departament\FindDepartamentUseCase;
use UicBundle\Application\UseCase\Departament\UpdateDepartamentUseCase;
...
class DepartamentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departamentFindAllUseCase = new FindAllDepartamentUseCase($em->getRepository('UicBundle:Departament\Departament'));
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('UicBundle\Form\Departament\DepartamentType', $departament);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $departamentCreateUseCase = new CreateDepartamentUseCase($em->getRepository('UicBundle:Departament\Departament'));
    ...
    public function showAction($id)
    {
       ...
       $departamentFindUseCase = new FindDepartamentUseCase($em->getRepository('UicBundle:Departament\Departament'));
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $deleteForm = $this->createDeleteForm($departament);
        $editForm = $this->createForm('UicBundle\Form\Departament\DepartamentType', $departament);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            $departamentUpdateUseCase = new UpdateDepartamentUseCase($em->getRepository('UicBundle:Departament\Departament'));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $departamentDeleteUseCase = new DeleteDepartamentUseCase($em->getRepository('UicBundle:Departament\Departament'));
